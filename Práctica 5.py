...
def get_alumnos():
    ...
    registros_raw = cursor.execute("select nombre, edad from alumnos")
...
menu_alumnos.add_command(label="Insertar Alumno", accelerator="(Ctrl+N)", command=nuevo_alumno)
